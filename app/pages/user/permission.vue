...
// ควบคุมการแสดงผลของ modal สำหรับผู้ใช้
  ...
  >
    <template #header>
      <div class="flex items-center justify-between">
        ...
        <!-- ปุ่มที่จัดให้อยู่ทางขวาสุด -->
        <UButton
          icon="tdesign:add-circle"
          size="sm"
          color="primary"
          variant="solid"
          label="เพิ่มผู้ใช้"
    ...
    <!-- User Modal -->
    <UserModal v-if="isUserModalOpen" @close="isUserModalOpen = false" />
  </UCard>
</template>
